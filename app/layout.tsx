          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-16">
            ...
            <div>
               ...
               <ul className="space-y-4 text-zinc-400 text-sm font-medium">
                  ...
                  <li><Link href="/reseller" className="hover:text-white transition-colors">Resellers</Link></li>
                  <li><Link href="/supplier" className="hover:text-white transition-colors">Suppliers</Link></li>
